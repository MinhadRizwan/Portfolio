...
const Header = () => { 
  ...
  return (
    ...
    <header /*ref={headerRef}* this is for sticky navbar*/ className="w-full h-[80px] bg-[#12141e] leading-[80px] flex items-center">
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex itmes-center gap-[10px]'>
            ...
            <div className='leading-[20px]'>
              <h2 className='text-xl text-white font-[700]'>Minhad Rizwan</h2>
          ...
          <div className='flex items-center gap-4'>
            <a href="https://drive.google.com/file/d/1sW5hYzfe7emLmf3_nJwWwuPt-VsW1kKG/view?usp=sharing" target='blank'><button className=' md:flex md:items-center mx-4 my-6 md:my-0 flex items-center gap-2 text-white font-[600] border border-solid
